...
public class CommonFixture {
	...
	protected ClientResponse response;
		...
		/** The JSON document under test, parsed into a Jackson tree. */
	protected JsonNode testSubject;

	/** The local file representing the IUT. */
	protected File testSubjectFile;
