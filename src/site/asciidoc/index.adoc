= SWE Common 3.0 Conformance Test Suite
...
`org.opengis.cite.swecommon30`. A conformance class corresponds to a &lt;test&gt; element, each
...
|Conformance Level 1
|org.opengis.cite.swecommon30.level1.*

|Conformance Level 2
|org.opengis.cite.swecommon30.level2.*
