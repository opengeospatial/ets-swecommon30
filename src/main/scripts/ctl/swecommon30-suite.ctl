...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tns="http://www.opengis.net/cite/swecommon30"
  xmlns:saxon="http://saxon.sf.net/"
  xmlns:tec="java:com.occamlab.te.TECore"
  xmlns:tng="java:org.opengis.cite.swecommon30.TestNGController">

  <ctl:function name="tns:run-ets-swecommon30">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the swecommon30 ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:suite name="tns:ets-swecommon30-${version}">
     <ctl:title>SWE Common 3.0 Conformance Test Suite</ctl:title>
	  ...
	  <ctl:code>
        <xsl:variable name="form-data">
           <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
             <h2>SWE Common 3.0 Conformance Test Suite</h2>
       ...
       <xsl:variable name="test-results">
        <ctl:call-function name="tns:run-ets-swecommon30">
